  ...
  if (msg.type === "narration")
    return (
      <div className="pb-6">
        ...
        {msg.timestamp && <div className="mt-1.5 font-sans text-[11px] text-muted">— {msg.timestamp}</div>}
      </div>
    );
  ...
  if (msg.type === "npc")
    return (
      <div className="mb-5 border-l-2 border-gold-dim pl-3.5">
        <div className="mb-1 font-sans text-[11px] tracking-wide text-gold">{msg.speaker}</div>
  ...
  if (msg.type === "player")
    return (
      <div className="mb-5 rounded border border-border bg-panel px-3.5 py-3">
        <div className="mb-1.5 font-sans text-[10px] uppercase tracking-widest text-gold">{t("yourAction")}</div>
    ...
    return (
      <div className="mb-5 flex items-center gap-2.5 rounded border border-[#2e4038] bg-[#1a2420] px-3 py-2">
        ...
        <div>
          ...
          {msg.speaker && <span className="ml-2.5 font-sans text-[11px] font-medium text-hp">{msg.speaker}</span>}
        </div>
      </div>
    );
    ...
    return (
      <div className="mb-5 rounded-r border-l-2 border-combat bg-[#1f1510] px-3.5 py-3">
        <div className="mb-1.5 flex items-center gap-1.5">
          ...
          <span className="font-sans text-[11px] font-medium uppercase tracking-wider text-combat">{msg.speaker}</span>
        </div>
