...
export const QuestCard = () => {
  ...
  return (
    <div className="border border-border bg-panel p-2.5">
      <div className="mb-1.5 font-sans text-base font-semibold uppercase text-foreground">{t("questTitle")}</div>
      ...
      <div className="mt-1 font-sans text-xs text-muted">{t("questProgress", { done: 1, total: 3 })}</div>
    </div>
  );
};
