    ...
    <div className="rounded border border-border bg-panel p-2.5">
      <div className="mb-2 flex items-center justify-between">
        <div>
          ...
          <div className="text-[13px] text-muted">{t("partyClass", { level: 3 })}</div>
        </div>
        <div className="rounded-[3px] border border-[#3d6040] bg-[#1e2a1e] px-[7px] py-0.5 text-[13px] text-hp">{t("ready")}</div>
      </div>
